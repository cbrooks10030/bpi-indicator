    ...
    questions: [
      {
        ...
        weight: 12,
        mandatory: true,
        hint: 'Either is fine. A CISD plus candle closure on the timeframe below is what tells you a C2 is about to form — it does not have to be 10:00 yet.',
      },
      {
        id: 'h4C2Direction',
      ...
      },
      {
        ...
        weight: 0,
        modifier: '+8%',
        hint: 'A swing point or resting stops taken out while the candle builds. Not required — a NO costs you nothing.',
      },
      {
        id: 'h4C2IntoFvg',
        ...
        weight: 0,
        modifier: '+5%',
        hint: 'Sweeping liquidity into an FVG on the same 4H candle is the most powerful version of this leg.',
      },
